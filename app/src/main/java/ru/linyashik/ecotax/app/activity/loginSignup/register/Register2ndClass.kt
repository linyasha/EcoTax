...
import ru.linyashik.ecotax.databinding.ActivityRegister2ndClassBinding

class Register2ndClass : AppCompatActivity() {
    //Variables
    private lateinit var binding: ActivityRegister2ndClassBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityRegister2ndClassBinding.inflate(layoutInflater)
        setContentView(binding.root)

        binding.signupNextBtn.setOnClickListener {
            val intent = Intent(this, Register3rdClass::class.java)
